...
public class AssetLoader {
    ...
    public enum Tokens implements AssetPath {
        ...
        KHORNE("Images/tokens/khorne.png"), NURGLE("Images/tokens/nurgle.png"),
        RED_X("Images/tokens/redX.png"), SLAANESH("Images/tokens/slaanesh.png"),
    ...
    public enum TriangleTable implements AssetPath {
        ...
        MINUS_GREEN("Images/triangleTable/minusGreen.png"), MINUS_RED("Images/triangleTable/minusRed.png"),
        OUTLINE("Images/triangleTable/outline.png"), PLUS_BLUE("Images/triangleTable/plusBlue.png"),
        PLUS_GREEN("Images/triangleTable/plusGreen.png"), PLUS_RED("Images/triangleTable/plusRed.png"),
        QUESTION_MARK("Images/triangleTable/questionMark.png"), QUESTION_MARK_WHITE("Images/triangleTable/questionMarkWhite.png"),
