...
public class DeckTest {
    ...
    void getFirstThreeWithLessThanThreeIngredients() {
        deck.addIngredient(Ingredient.IngredientTypes.Plant, 1);
    ...
    void getFirstThreeWithExactlyThreeIngredients() {
        deck.addIngredient(Ingredient.IngredientTypes.Plant, 1);
        deck.addIngredient(Ingredient.IngredientTypes.Mandrake, 1);
        deck.addIngredient(Ingredient.IngredientTypes.Flower, 1);
    ...
    void getFirstThreeCorrectOrder() {
        ...
        deck.addIngredient((Ingredient.IngredientTypes.Mandrake), 1);
        deck.addIngredient((Ingredient.IngredientTypes.Flower), 1);
        HashMap<Integer, Ingredient.IngredientTypes> firstThree = deck.getFirstThree();
        assertEquals(Ingredient.IngredientTypes.Plant, firstThree.get(0), "First ingredient should be Plant");
        assertEquals(Ingredient.IngredientTypes.Mandrake, firstThree.get(1),
                     "Second ingredient should be Mandrake");
        assertEquals(Ingredient.IngredientTypes.Flower, firstThree.get(2),
    ...
    void getFirstThreeWithDuplicateIngredients() {
        ...
        deck.addIngredient((Ingredient.IngredientTypes.Plant), 1);
        HashMap<Integer, Ingredient.IngredientTypes> firstThree = deck.getFirstThree();
        assertTrue(firstThree.values().stream().allMatch(i -> i == Ingredient.IngredientTypes.Plant),
    ...
    void setFirstThreeInEmptyDeck() {
        HashMap<Integer, Ingredient.IngredientTypes> newFirstThree = new HashMap<>();
        Ingredient.IngredientTypes ingredient1 = Ingredient.IngredientTypes.Plant;
    ...
    void replaceExistingFirstThree() {
        ...
        HashMap<Integer, Ingredient.IngredientTypes> newFirstThree = new HashMap<>();
        Ingredient.IngredientTypes newIngredient = Ingredient.IngredientTypes.Mushroom;
        newFirstThree.put(0, newIngredient);
        deck.setFirstThree(newFirstThree);

        assertEquals(Ingredient.IngredientTypes.Mushroom, deck.getFirstThree().get(0),
    ...
    void setFirstThreeAtSpecificIndex() {
        ...
        assertEquals(Ingredient.IngredientTypes.Mushroom, deck.getFirstThree().get(1),
    ...
    void ignoreInvalidPositions() {
        HashMap<Integer, Ingredient.IngredientTypes> newFirstThree = new HashMap<>();
        Ingredient.IngredientTypes ingredient = (Ingredient.IngredientTypes.Plant);
    ...
    void maintainOrderInFirstThree() {
        HashMap<Integer, Ingredient.IngredientTypes> newFirstThree = new HashMap<>();
        Ingredient.IngredientTypes ingredient1 = (Ingredient.IngredientTypes.Plant);
        Ingredient.IngredientTypes ingredient2 = (Ingredient.IngredientTypes.Mandrake);
        newFirstThree.put(0, ingredient1);
        newFirstThree.put(1, ingredient2);
        deck.setFirstThree(newFirstThree);

        assertEquals(Ingredient.IngredientTypes.Plant, deck.getFirstThree().get(0),
                     "First ingredient should be Plant");
        assertEquals(Ingredient.IngredientTypes.Mandrake, deck.getFirstThree().get(1),
                     "Second ingredient should be Mandrake");
    }
    ...
    void shuffleIngredientsNonEmptyDeck() {
        ...
        ArrayList<Ingredient.IngredientTypes> ingredientsBeforeShuffle = new ArrayList<>(deck.getIngredients());
        deck.shuffleIngredients();
        ArrayList<Ingredient.IngredientTypes> ingredientsAfterShuffle = deck.getIngredients();
    ...
    @AfterAll
    static void ded() {
        deck = null; // Nullify the reference
    }
