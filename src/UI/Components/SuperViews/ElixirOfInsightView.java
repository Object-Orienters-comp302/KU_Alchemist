...
public class ElixirOfInsightView extends JPanel {
    ...
    public ElixirOfInsightView(HashMap<Integer, Ingredient.IngredientTypes> firstThree) { // this is for online
        ...
        button.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                if(GameController.getInstance().isOnline()){
                    GameClient.getInstance().sendAction(new GameAction(GameAction.ActionType.USE_ELIXIR,"USE_ELIXIR",firstThree));
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(() -> {
            ...
            ElixirOfInsightView elixirView = new ElixirOfInsightView(Deck.getInstance().getFirstThree());
