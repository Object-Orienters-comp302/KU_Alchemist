...
public class PotionButtonPopup extends JPanel {
    ...
    public PotionButtonPopup(int x, int y, int width, int height, ImagePanel imgPanel, PotionButton ingre) {
        ...
        PotionPopupButton B0 =
                new PotionPopupButton(width * 4 / 8, height * 4 / 8, width * 8 / 16, height * 8 / 16,
        ...
        PotionPopupButton B4 =
                new PotionPopupButton(width * 3 / 8, height * 7 / 8, width * 5 / 16, height * 5 / 16,
        ...
        PotionPopupButton B5 =
                new PotionPopupButton(width * 5 / 8, height * 7 / 8, width * 5 / 16, height * 5 / 16,
        ...
        PotionPopupButton B6 =
                new PotionPopupButton(width * 7 / 8, height * 5 / 8, width * 5 / 16, height * 5 / 16,
        ...
        PotionPopupButton B7 =
                new PotionPopupButton(width * 7 / 8, height * 3 / 8, width * 5 / 16, height * 5 / 16,
